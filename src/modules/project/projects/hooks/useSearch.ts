...
import type { ProjectSearchData } from '../types/project.types';
...
export const useProjectSearchParams = () => {
  ...
  const setProjectSearchData = (updated: Partial<ProjectSearchData>) => {
    ...
    const appendKey = <K extends keyof ProjectSearchData>(
      key: K,
      value: ProjectSearchData[K],
    ): void => {
    ...
    (
      Object.entries(fullSearchData) as [
        keyof ProjectSearchData,
        ProjectSearchData[keyof ProjectSearchData],
      ][]
