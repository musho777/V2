...
import type { ArchiveDepartmentSearchData } from '../types/archive-department.types';

const defaultSearchData: ArchiveDepartmentSearchData = {
  size: 10,
  page: 0,
  search: '',
};

export const useArchiveDepartmentSearchParams = () => {
  ...
  const setSearchData = (updated: Partial<ArchiveDepartmentSearchData>) => {
    ...
    const appendKey = <K extends keyof ArchiveDepartmentSearchData>(
      key: K,
      value: ArchiveDepartmentSearchData[K],
    ): void => {
    ...
    (
      Object.entries(fullSearchData) as [
        keyof ArchiveDepartmentSearchData,
        ArchiveDepartmentSearchData[keyof ArchiveDepartmentSearchData],
      ][]
