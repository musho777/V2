...
import type { SubProjectTableRow } from '../types/sub-project.types';
...
export const createColumns = ({
  ...
  handleStatusChange,
  isGeneralManager,
}: ColumnConfig): ColumnsType<SubProjectTableRow> => [
  {
  ...
  },
  {
    ...
    dataIndex: 'status',
    key: 'status',
    render: (status: string, record: SubProjectTableRow) => {
  ...
  },
  {
    title: 'ACTION',
    key: 'action',
    render: (_: unknown, record: SubProjectTableRow) =>
      isGeneralManager ? (
        <EditOutlined
